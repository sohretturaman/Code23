...
import { homeIcon,menu,search} from '../assets/icons/index';
  ...
  return (
    <ScrollView
      ...
      <View
        ...
        <Image
          source={menu}
          style={{width: winWidth * 0.055, height: winWidth * 0.06}}
        />
        <View>
          <Image
            source={pImage}
      ...
      <View
        ...
        <ScrollView
          horizontal={true}
          style={{height: winWidth * 0.5, paddingHorizontal: winWidth * 0.02}}>
      ...
      <View
        ...
        <View
          ...
          <View
            ...
            <Image
              source={search}
              style={{width: winWidth * 0.04, height: winWidth * 0.04}}
              tintColor={'white'}
            />
          </View>
        </View>
